...
- `backend/`: API REST (FastAPI, SQLModel, Alembic, pytest).
- `frontend/`: SPA con React, Vite y Material UI (o equivalente).
- `.github/`: configuraciones de automatización y guías.